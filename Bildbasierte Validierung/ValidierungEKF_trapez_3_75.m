clear all; close all;
load('input_ekf_3.75_trapez.mat');
...
figure(4)
subplot(2,1,1),
plot(tMeas, phi1EstDeg), title('Gelenkwinkel ab ca. 10 Sek. chaotisches Verhalten des äußeren Pendels'), hold on
...
figure(5), 
subplot(2,1,1),
plot(tMeas,dphi1EstDeg), title('Gelenkwinkelgeschw. ab ca. 10 Sek. chaotisches Verhalten des äußeren Pendels'), hold on

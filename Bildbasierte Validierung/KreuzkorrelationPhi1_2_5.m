clear all, close all
load('harm_erregung2.5_1002.mat')
load('video_angles_2.5_harmonisch_1002.mat')
%% plot für jour fixe
% figure, 
...
%%
save('input_ekf_2.5_v2.mat','tMeas','phi1MeasDeg','dphi1MeasDeg','ddphi1MeasDeg','phi1VideoDeg','phi2VideoDeg','xMeasReal','dxDes','ddxDes')
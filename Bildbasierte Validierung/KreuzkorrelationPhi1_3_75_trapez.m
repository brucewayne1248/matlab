clear all, close all
load('trapez_erregung3.75_1002.mat');
load('video_angles_3.75_trapez_1002.mat');
%% plot für jour fixe
% figure, 
...
%% 
phi1VideoDeg = phi1Resample(lagDiff:lagDiff+seconds*10^3)+0.5;
phi2VideoDeg = phi2Resample(lagDiff:lagDiff+seconds*10^3)+0.5;
...
%%
save('input_ekf_3.75_trapez.mat','tMeas','phi1MeasDeg','dphi1MeasDeg','ddphi1MeasDeg','phi1VideoDeg','phi2VideoDeg','xMeasReal','dxDes','ddxDes', 'vmax')
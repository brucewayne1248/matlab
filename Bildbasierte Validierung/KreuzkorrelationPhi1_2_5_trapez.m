clear all, close all
load('trapez_erregung2.5_1002.mat');
load('video_angles_2.5_trapez_1002.mat');
%% plot für jour fixe
% figure, 
...
%% 
% phi1VideoDeg = phi1Resample(lagDiff:lagDiff+seconds*10^3);
% phi2VideoDeg = phi2Resample(lagDiff:lagDiff+seconds*10^3);
...
%%
save('input_ekf_2.5_trapez.mat','tMeas','phi1MeasDeg','dphi1MeasDeg','ddphi1MeasDeg','phi1VideoDeg','phi2VideoDeg','xMeasReal','dxDes','ddxDes', 'vmax')
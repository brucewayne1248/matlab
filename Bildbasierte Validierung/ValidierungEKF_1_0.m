...
dphi2VideoDeg = [0 dphi2VideoDeg];
dphi2VideoDegMag = abs(fft(dphi2VideoDeg));

% figure(1),
% plot(tMeas,dphi2VideoDeg), title('dphi2 ungefiltert')
% xlabel('t in Sek.')
% ylabel('Grad/s')
...
xlabel('t in Sek.')
ylabel('Grad/s')
title('Harm. Anregung: Winkelgeschwindigkeiten')
hold off

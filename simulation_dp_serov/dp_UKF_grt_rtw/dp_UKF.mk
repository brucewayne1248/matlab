###########################################################################
## Makefile generated for Simulink model 'dp_UKF'. 
## 
## Makefile     : dp_UKF.mk
## Generated on : Thu Nov 24 14:24:55 2016
## MATLAB Coder version: 3.0 (R2015b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\dp_UKF.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Users\serov\Documents\MATLAB\simulation_dp_serov
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = dp_UKF_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = dp_UKF_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\dp_UKF.exe
...
INCLUDES_BUILDINFO = $(START_DIR)\dp_UKF_grt_rtw;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common
...
DEFINES_STANDARD = -DMODEL=dp_UKF -DNUMST=2 -DNCSTATES=6 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\dp_UKF_grt_rtw\dp_UKF.c $(START_DIR)\dp_UKF_grt_rtw\dp_UKF_data.c $(START_DIR)\dp_UKF_grt_rtw\rtGetInf.c $(START_DIR)\dp_UKF_grt_rtw\rtGetNaN.c $(START_DIR)\dp_UKF_grt_rtw\rt_nonfinite.c rt_logging.c
...
OBJS = dp_UKF.obj dp_UKF_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
{$(START_DIR)\dp_UKF_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\dp_UKF_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"

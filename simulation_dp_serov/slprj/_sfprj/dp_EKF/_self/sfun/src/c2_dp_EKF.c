...
#include <stddef.h>
#include "blas.h"
#include "dp_EKF_sfun.h"
#include "c2_dp_EKF.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "dp_EKF_sfun_debug_macros.h"
...
static void initialize_c2_dp_EKF(SFc2_dp_EKFInstanceStruct *chartInstance);
static void initialize_params_c2_dp_EKF(SFc2_dp_EKFInstanceStruct *chartInstance);
static void enable_c2_dp_EKF(SFc2_dp_EKFInstanceStruct *chartInstance);
static void disable_c2_dp_EKF(SFc2_dp_EKFInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_dp_EKF(SFc2_dp_EKFInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_dp_EKF(SFc2_dp_EKFInstanceStruct
  *chartInstance);
static void set_sim_state_c2_dp_EKF(SFc2_dp_EKFInstanceStruct *chartInstance,
  const mxArray *c2_st);
static void finalize_c2_dp_EKF(SFc2_dp_EKFInstanceStruct *chartInstance);
static void sf_gateway_c2_dp_EKF(SFc2_dp_EKFInstanceStruct *chartInstance);
static void mdl_start_c2_dp_EKF(SFc2_dp_EKFInstanceStruct *chartInstance);
static void c2_chartstep_c2_dp_EKF(SFc2_dp_EKFInstanceStruct *chartInstance);
static void initSimStructsc2_dp_EKF(SFc2_dp_EKFInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_dp_EKFInstanceStruct *chartInstance, const
  mxArray *c2_b_P_p, const char_T *c2_identifier, real_T c2_b_y[16]);
static void c2_b_emlrt_marshallIn(SFc2_dp_EKFInstanceStruct *chartInstance,
  const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_b_y[16]);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_dp_EKFInstanceStruct *chartInstance,
  const mxArray *c2_b_x_p, const char_T *c2_identifier, real_T c2_b_y[4]);
static void c2_d_emlrt_marshallIn(SFc2_dp_EKFInstanceStruct *chartInstance,
  const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_b_y[4]);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_dp_EKFInstanceStruct *chartInstance,
  const mxArray *c2_b_K, const char_T *c2_identifier, real_T c2_b_y[4]);
static void c2_f_emlrt_marshallIn(SFc2_dp_EKFInstanceStruct *chartInstance,
  const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_b_y[4]);
...
static const mxArray *c2_f_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_g_emlrt_marshallIn(SFc2_dp_EKFInstanceStruct *chartInstance,
  const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_g_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_h_emlrt_marshallIn(SFc2_dp_EKFInstanceStruct *chartInstance,
  const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_b_y[16]);
...
static real_T c2_mpower(SFc2_dp_EKFInstanceStruct *chartInstance, real_T c2_a);
static void c2_eml_scalar_eg(SFc2_dp_EKFInstanceStruct *chartInstance);
static void c2_b_eml_scalar_eg(SFc2_dp_EKFInstanceStruct *chartInstance);
static void c2_threshold(SFc2_dp_EKFInstanceStruct *chartInstance);
static void c2_c_eml_scalar_eg(SFc2_dp_EKFInstanceStruct *chartInstance);
static void c2_d_eml_scalar_eg(SFc2_dp_EKFInstanceStruct *chartInstance);
static real_T c2_eml_xdotu(SFc2_dp_EKFInstanceStruct *chartInstance, real_T
  c2_b_x[4], real_T c2_b_y[4]);
static void c2_eye(SFc2_dp_EKFInstanceStruct *chartInstance, real_T c2_I[16]);
static const mxArray *c2_h_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_i_emlrt_marshallIn(SFc2_dp_EKFInstanceStruct *chartInstance,
  const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_j_emlrt_marshallIn(SFc2_dp_EKFInstanceStruct *chartInstance,
  const mxArray *c2_b_is_active_c2_dp_EKF, const char_T *c2_identifier);
static uint8_T c2_k_emlrt_marshallIn(SFc2_dp_EKFInstanceStruct *chartInstance,
  const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_dp_EKFInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc2_dp_EKFInstanceStruct *chartInstance);
...
static void initialize_c2_dp_EKF(SFc2_dp_EKFInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_dp_EKF = 0U;
}
  ...
  *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_dp_EKF;
  ...
  const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_dp_EKF = c2_j_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_b_u, 4)), "is_active_c2_dp_EKF");
  sf_mex_destroy(&c2_b_u);
  c2_update_debugger_state_c2_dp_EKF(chartInstance);
...
static void sf_gateway_c2_dp_EKF(SFc2_dp_EKFInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_dp_EKF(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_dp_EKFMachineNumber_,
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  real_T c2_b_u[16];
  const mxArray *c2_b_y = NULL;
  SFc2_dp_EKFInstanceStruct *chartInstance;
  chartInstance = (SFc2_dp_EKFInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_dp_EKF_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c2_b_is_active_c2_dp_EKF, const char_T *c2_identifier)
{
  ...
  c2_b_y = c2_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_dp_EKF), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_dp_EKF);
  return c2_b_y;
}
...
void sf_c2_dp_EKF_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3796763656U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(811569380U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1271478942U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1563748096U);
}

mxArray* sf_c2_dp_EKF_get_post_codegen_info(void);
mxArray *sf_c2_dp_EKF_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("yuLrGIjzgzfyC3vVYEDcVD");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_dp_EKF_get_post_codegen_info();
...
mxArray *sf_c2_dp_EKF_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_dp_EKF_jit_fallback_info(void)
{
...
mxArray *sf_c2_dp_EKF_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_dp_EKF(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[13],T\"K\",},{M[1],M[12],T\"x\",},{M[4],M[0],T\"P_p\",S'l','i','p'{{M1x2[439 442],M[0],}}},{M[4],M[0],T\"x_p\",S'l','i','p'{{M1x2[435 438],M[0],}}},{M[8],M[0],T\"is_active_c2_dp_EKF\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_dp_EKF_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_dp_EKFInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_dp_EKFMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_dp_EKFMachineNumber_,
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,8331);
        _SFD_CV_INIT_EML_IF(0,1,0,609,624,717,8331);
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _dp_EKFMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "r7jJJtP1ZMiIltgDpDkBqF";
}

static void sf_opaque_initialize_c2_dp_EKF(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_dp_EKFInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c2_dp_EKF((SFc2_dp_EKFInstanceStruct*) chartInstanceVar);
  initialize_c2_dp_EKF((SFc2_dp_EKFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_dp_EKF(void *chartInstanceVar)
{
  enable_c2_dp_EKF((SFc2_dp_EKFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_dp_EKF(void *chartInstanceVar)
{
  disable_c2_dp_EKF((SFc2_dp_EKFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_dp_EKF(void *chartInstanceVar)
{
  sf_gateway_c2_dp_EKF((SFc2_dp_EKFInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_dp_EKF(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_dp_EKF((SFc2_dp_EKFInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_dp_EKF(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_dp_EKF((SFc2_dp_EKFInstanceStruct*)chartInfo->chartInstance,
    st);
}

static void sf_opaque_terminate_c2_dp_EKF(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_dp_EKFInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_dp_EKF_optimization_info();
    }

    finalize_c2_dp_EKF((SFc2_dp_EKFInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_dp_EKF((SFc2_dp_EKFInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_dp_EKF(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_dp_EKF((SFc2_dp_EKFInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_dp_EKF(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_dp_EKF_optimization_info();
  ...
  ssSetChecksum0(S,(205855519U));
  ssSetChecksum1(S,(651498531U));
  ssSetChecksum2(S,(358788531U));
  ssSetChecksum3(S,(3159473256U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_dp_EKF(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_dp_EKF(SimStruct *S)
{
  SFc2_dp_EKFInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_dp_EKFInstanceStruct *)utMalloc(sizeof
    (SFc2_dp_EKFInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_dp_EKFInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_dp_EKF;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_dp_EKF;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_dp_EKF;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_dp_EKF;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_dp_EKF;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_dp_EKF;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_dp_EKF;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_dp_EKF;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_dp_EKF;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_dp_EKF;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_dp_EKF;
...
void c2_dp_EKF_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_dp_EKF(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_dp_EKF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_dp_EKF(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_dp_EKF_method_dispatcher.\n"

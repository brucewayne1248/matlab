...
static void initialize_c5_dp_EKF_anregung(SFc5_dp_EKF_anregungInstanceStruct
  *chartInstance);
static void initialize_params_c5_dp_EKF_anregung
  (SFc5_dp_EKF_anregungInstanceStruct *chartInstance);
static void enable_c5_dp_EKF_anregung(SFc5_dp_EKF_anregungInstanceStruct
  *chartInstance);
static void disable_c5_dp_EKF_anregung(SFc5_dp_EKF_anregungInstanceStruct
  *chartInstance);
static void c5_update_debugger_state_c5_dp_EKF_anregung
  (SFc5_dp_EKF_anregungInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_dp_EKF_anregung
  (SFc5_dp_EKF_anregungInstanceStruct *chartInstance);
static void set_sim_state_c5_dp_EKF_anregung(SFc5_dp_EKF_anregungInstanceStruct *
  chartInstance, const mxArray *c5_st);
static void finalize_c5_dp_EKF_anregung(SFc5_dp_EKF_anregungInstanceStruct
  *chartInstance);
static void sf_gateway_c5_dp_EKF_anregung(SFc5_dp_EKF_anregungInstanceStruct
  *chartInstance);
static void mdl_start_c5_dp_EKF_anregung(SFc5_dp_EKF_anregungInstanceStruct
  *chartInstance);
static void initSimStructsc5_dp_EKF_anregung(SFc5_dp_EKF_anregungInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static real_T c5_emlrt_marshallIn(SFc5_dp_EKF_anregungInstanceStruct
  *chartInstance, const mxArray *c5_b_ddphi2, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn(SFc5_dp_EKF_anregungInstanceStruct
...
static real_T c5_mpower(SFc5_dp_EKF_anregungInstanceStruct *chartInstance,
  real_T c5_a);
static void c5_eml_scalar_eg(SFc5_dp_EKF_anregungInstanceStruct *chartInstance);
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_c_emlrt_marshallIn(SFc5_dp_EKF_anregungInstanceStruct
  *chartInstance, const mxArray *c5_b_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_d_emlrt_marshallIn(SFc5_dp_EKF_anregungInstanceStruct
  *chartInstance, const mxArray *c5_b_is_active_c5_dp_EKF_anregung, const char_T
  *c5_identifier);
static uint8_T c5_e_emlrt_marshallIn(SFc5_dp_EKF_anregungInstanceStruct
  *chartInstance, const mxArray *c5_b_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_dp_EKF_anregungInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc5_dp_EKF_anregungInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_dp_EKF_anregung = 0U;
}
  ...
  (SFc5_dp_EKF_anregungInstanceStruct *chartInstance)
{
  ...
  c5_c_hoistedGlobal = chartInstance->c5_is_active_c5_dp_EKF_anregung;
  ...
  chartInstance, const mxArray *c5_st)
{
  ...
  *chartInstance->c5_ddphi2 = c5_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c5_is_active_c5_dp_EKF_anregung = c5_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c5_b_u, 2)),
     "is_active_c5_dp_EKF_anregung");
  sf_mex_destroy(&c5_b_u);
  c5_update_debugger_state_c5_dp_EKF_anregung(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  const mxArray *c5_y = NULL;
  SFc5_dp_EKF_anregungInstanceStruct *chartInstance;
  chartInstance = (SFc5_dp_EKF_anregungInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c5_dp_EKF_anregung_get_eml_resolved_functions_info(void)
{
  ...
  *c5_identifier)
{
  ...
  c5_y = c5_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_dp_EKF_anregung), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_dp_EKF_anregung);
  return c5_y;
}
...
void sf_c5_dp_EKF_anregung_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c5_dp_EKF_anregung_get_post_codegen_info(void);
mxArray *sf_c5_dp_EKF_anregung_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c5_dp_EKF_anregung_get_post_codegen_info();
...
mxArray *sf_c5_dp_EKF_anregung_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_dp_EKF_anregung_jit_fallback_info(void)
{
...
mxArray *sf_c5_dp_EKF_anregung_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_dp_EKF_anregung(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"ddphi1\",},{M[1],M[6],T\"ddphi2\",},{M[8],M[0],T\"is_active_c5_dp_EKF_anregung\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_dp_EKF_anregung_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc5_dp_EKF_anregungInstanceStruct *)
...
static void sf_opaque_initialize_c5_dp_EKF_anregung(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_dp_EKF_anregungInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c5_dp_EKF_anregung((SFc5_dp_EKF_anregungInstanceStruct*)
    chartInstanceVar);
  initialize_c5_dp_EKF_anregung((SFc5_dp_EKF_anregungInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c5_dp_EKF_anregung(void *chartInstanceVar)
{
  enable_c5_dp_EKF_anregung((SFc5_dp_EKF_anregungInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c5_dp_EKF_anregung(void *chartInstanceVar)
{
  disable_c5_dp_EKF_anregung((SFc5_dp_EKF_anregungInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c5_dp_EKF_anregung(void *chartInstanceVar)
{
  sf_gateway_c5_dp_EKF_anregung((SFc5_dp_EKF_anregungInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c5_dp_EKF_anregung(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c5_dp_EKF_anregung((SFc5_dp_EKF_anregungInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c5_dp_EKF_anregung(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c5_dp_EKF_anregung((SFc5_dp_EKF_anregungInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c5_dp_EKF_anregung(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_dp_EKF_anregungInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c5_dp_EKF_anregung((SFc5_dp_EKF_anregungInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc5_dp_EKF_anregung((SFc5_dp_EKF_anregungInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_dp_EKF_anregung(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_dp_EKF_anregung(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c5_dp_EKF_anregung(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_dp_EKF_anregung(SimStruct *S)
{
  SFc5_dp_EKF_anregungInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_dp_EKF_anregungInstanceStruct *)utMalloc(sizeof
    (SFc5_dp_EKF_anregungInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_dp_EKF_anregungInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_dp_EKF_anregung;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_dp_EKF_anregung;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_dp_EKF_anregung;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_dp_EKF_anregung;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_dp_EKF_anregung;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_dp_EKF_anregung;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_dp_EKF_anregung;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_dp_EKF_anregung;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_dp_EKF_anregung;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_dp_EKF_anregung;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_dp_EKF_anregung;
...
void c5_dp_EKF_anregung_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_dp_EKF_anregung(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_dp_EKF_anregung(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_dp_EKF_anregung(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_dp_EKF_anregung_method_dispatcher.\n"

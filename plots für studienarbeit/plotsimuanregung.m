...
figure(1)
subplot(2,1,1)
plot(t,phi1,'g','LineWidth',1.1), hold on
plot(t,phi1Est,'b--','LineWidth',1.1)
plot(t,phi2,'r','LineWidth',1.1)
...
subplot(2,1,2)
plot(t,dphi1,'g','LineWidth',1.1), hold on
plot(t,dphi1Est,'b--','LineWidth',1.1)
plot(t,dphi2,'r','LineWidth',1.1)

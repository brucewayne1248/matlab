...
\NewDocumentCommand{\angsi}{omom}{%			% für °/s
	\ang[#1]{#2}\si[#3]{#4}%
}		
\usepackage{algorithmicx}					% für algorithmen
\usepackage{algpseudocode}					% für algorithmen
\usepackage{algorithm}						% für algorithmen
\usepackage{tabu}							% für dicke linien in tabellen

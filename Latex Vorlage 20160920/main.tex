% LaTeX Datei für Projektarbeiten etc. am MZH
...
% ------------------------------------------------------------------------------------------
\input{praeambel}                           % Präambel zur Dokumentenformatierung einfügen
...
\usepackage{tikz}							% package für blockschaltbilder in latex
...
\usepackage{bm}								% für fettgedruckte ausdrücke in Mathe-Umgebung \bm{math expression}
\usepackage{mathtools}						% für *Matrizen zum Ausrichten der Einträge
\usepackage{dsfont}						% für die mathematischen zeichen wie  x enthalten in Relle Zahlen -> fancy R
